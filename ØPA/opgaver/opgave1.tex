...
\begin{frame}
Et land producerer 2 goder, biler og brød. En tranformationskurve er givet ved de følgende punkter
\begin{align*}
&\textrm{Biler} = (0,10,20,30,40) \\
&\textrm{Brød} = (70,60,45,25,0)
\end{align*}

Tegn transformationskurven, diskuter alternativomkostninger, teknologi mm.
